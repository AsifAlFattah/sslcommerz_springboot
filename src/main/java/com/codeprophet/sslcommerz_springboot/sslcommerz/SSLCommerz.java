package com.codeprophet.sslcommerz_springboot.sslcommerz;

import com.codeprophet.sslcommerz_springboot.sslcommerz.Utility.ParameterBuilder;
import com.codeprophet.sslcommerz_springboot.sslcommerz.Utility.Util;
import com.codeprophet.sslcommerz_springboot.sslcommerz.parametermappings.SSLCommerzInitResponse;
import com.codeprophet.sslcommerz_springboot.sslcommerz.parametermappings.SSLCommerzValidatorResponse;
...
public class SSLCommerz {
    ...
    private void setSSLCzTestMode(boolean storeTestMode) {
        ...
        if (storeTestMode) {
//             this.storeId = "codep66d6f3377b488";
//             this.storePass = "codep66d6f3377b488@ssl";
